...
-- Schema a3emprestimo
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `a3emprestimo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `a3emprestimo` ;

-- -----------------------------------------------------
-- Table `a3emprestimo`.`tb_amigo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `a3emprestimo`.`tb_amigo` (
...
-- -----------------------------------------------------
-- Table `a3emprestimo`.`tb_ferramenta`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `a3emprestimo`.`tb_emprestimo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `a3emprestimo`.`tb_emprestimo` (
  ...
  CONSTRAINT `fk_tb_emprestimo_tb_amigo`
    ...
    REFERENCES `a3emprestimo`.`tb_amigo` (`id_amigo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tb_emprestimo_tb_ferramenta1`
    FOREIGN KEY (`tb_ferramenta_id_ferramenta`)
    REFERENCES `a3emprestimo`.`tb_ferramenta` (`id_ferramenta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
